<script lang="ts">
	...
	export let data;
	const parsed = bibTeXParse.toJSON(data.data)[0].entryTags;
</script>

<section class="flex-1 flex flex-col gap-8 items-center my-32 px-12">
	<h1 class="w-4/5 text-left text-3xl font-light">
