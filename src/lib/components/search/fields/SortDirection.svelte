...
<li class="flex flex-col md:flex-row items-start md:items-center justify-between p-2 py-4 gap-6 lg:gap-12">
	<div >
	...
	<div class="flex flex-wrap items-center gap-x-12 gap-y-4 justify-start md:justify-end">
